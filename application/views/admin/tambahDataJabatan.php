...
<div class="card" style="width: 60%; margin-bottom: 100px">
    ...
    <div class="form-group">
        ...
        <input type="number" name="gaji_pokok" class="form-control" min="1">
        <?php echo form_error('gaji_pokok','<div class="text-small text-danger"></div>') ?>
    </div>

    <div class="form-group">
        <label>Tunjangan Transport</label>
        <input type="number" name="transport" class="form-control" min="1">
        <?php echo form_error('transport','<div class="text-small text-danger"></div>') ?>
    </div>

    <div class="form-group">
        <label>Uang Makan</label>
        <input type="number" name="uang_makan" class="form-control" min="1">
