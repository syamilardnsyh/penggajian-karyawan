    ...
    <form>
        ...
        <button style="width:100%" type="submit" class="btn btn-primary mb-2 ml-auto"></i>Konfirmasi Bulan dan Tahun</button><br>
                <?php if(count($presensi) > 0){?>
                    <a style="width:100%" href="<?php echo base_url('direktur/laporanPresensi/cetakLaporanPresensi?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success"><i class="fas fa-print"></i> Cetak Laporan Presensi Pegawai </a>
                <?php }else{ ?>
